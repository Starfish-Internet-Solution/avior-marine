...
require_once 'Project/Code/System/Articles/subcategory.php';
...
//-------------------------------------------------------------------------------------------------
	...
	public function logEvent($message)
	{
		try
		{
			$fh = fopen(STAR_SITE_ROOT."/Project/Code/2_Enterprise/Applications/Articles/Controllers/subcategory/log.txt", 'a') or die('no such file');
