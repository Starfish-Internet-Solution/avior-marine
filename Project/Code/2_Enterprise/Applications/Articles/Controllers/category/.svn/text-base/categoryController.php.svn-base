...
require_once 'Project/Code/System/Articles/category.php';
...
//-------------------------------------------------------------------------------------------------
	...
	{
		$fh = fopen(STAR_SITE_ROOT."/Project/Code/2_Enterprise/Applications/Articles/Controllers/category/log.txt", 'a') or die('no such file');
