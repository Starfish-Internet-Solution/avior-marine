...
require_once 'Project/Code/System/Products/subcategory.php';
...
//-------------------------------------------------------------------------------------------------
	...
	public function logEvent($message)
	{
		try
		{
			$fh = fopen(STAR_SITE_ROOT."/Project/Code/2_Enterprise/Applications/Products/Controllers/subcategory/log.txt", 'a') or die('no such file');
