	...
	public function select()
	{
		...
		try
		{
			...
			$sql = "SELECT
				...
				$this->url_name 		= $result['url_name'];
				$this->link_title		= $result['link_title'];
...
//-------------------------------------------------------------------------------------------------
	...
	public function selectFirst()
	{
		try
		{
			...
			$sql = "SELECT
						...
						WHERE	
							category_url = '/{$this->current_page}'
						LIMIT 0,1 ";
	...
	public function selectFirstLink()
	{
		try
		{
			$pdo_connection = starfishDatabase::getConnection();
...
//-------------------------------------------------------------------------------------------------	
	...
	public function update()
	{
		try
		{
			...
			$sql = "
				...
				$pdo_statement = $pdo_connection->prepare($sql);
				$pdo_statement->bindParam(':product_title', $this->product_title, PDO::PARAM_STR);
				$pdo_statement->bindParam(':url_name', $this->url_name, PDO::PARAM_STR);
				$pdo_statement->bindParam(':product_id', $this->product_id, PDO::PARAM_INT);
				$pdo_statement->execute();
		}
		catch(PDOException $pdoe)
	...
	public function updateFile()
	{
		try
		{
			...
			$pdo_statement->bindParam(':product_title', $this->product_title, PDO::PARAM_STR);
			$pdo_statement->bindParam(':url_name', $this->url_name, PDO::PARAM_STR);
			$pdo_statement->bindParam(':link_title', $this->link_title, PDO::PARAM_STR);
			$pdo_statement->bindParam(':product_id', $this->product_id, PDO::PARAM_INT);
			$pdo_statement->execute();
		}
		catch(PDOException $pdoe)
